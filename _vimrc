...
inoremap ùù ;
inoremap §§ '
" uložení aktuálnì editovaného souboru
map <F2> :w<CR>
" skok na pøedchozí chybové hlášení
map <F3> :cp<CR>
" skok na následujíící chybové hlášení
map <F4> :cn<CR>
" uložení aktuálnì editovaného souboru a spuštìní pøekladu
map <F9> :w<CR>:make<CR>
" výpis všech chybových hlášení pøekladaèe
map <F10> :cl<CR><CR>
" otevøení netrw
map <F11> :Explore<CR>
" otevøení NERDtree
...
" {{{ Calendar settings
let g:calendar_navi_label = 'Minulý,Tento,Pøíští'
